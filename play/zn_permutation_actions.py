...
print("stabilizer size of 1 =", R12.unit_action_stabilizer_size(1))
print("stabilizer size of 6 =", R12.unit_action_stabilizer_size(6))
...
print("stabilizer size of 1 =", R7.unit_action_stabilizer_size(1))
